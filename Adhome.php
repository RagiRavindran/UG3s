        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    <li ><a href="UpUniNews.php">Updating University News</a></li>
                     <li><a href="UpEQuestions.php">Updating Model Entrance Questions</a></li>
                    <li><a href="UpAptitude.php">Updating Aptitude Test Question</a></li>
                     <li><a href="viewcollege.php">View College</a></li>
                    <li> <a href="ViewStudent.php">View Students</a></li>
                    <li><a href="Complaint.php">View Complaint of Teacher</a></li>
                     <li><a href="viewcomplaints.php">View Complaint of Student</a></li>
                     <li><a href="Feedback.php">View Feedbacks</a></li>
                       <li><a href="UpStudy.php">Update Study Materials</a></li>
 ...
 <div class="container">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        ...
                        <li>
							  ...
							  <h1>UG3S</h1>
							  <h3>Under Graduate Student Supporting System</h3>
                           <h2>THE UNIQUE METHOD</h2>
  ...
  --> -->      <!--HOME SECTION END-->   
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE UG3S<i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
